...
export default function Wallet() {
  ...
  const generateWalletMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      verifyWalletMutation.mutate(data.address);
    },
    onError: (error: Error) => {
      toast({
  ...
  const handleVerifyWallet = () => {
    ...
    verifyWalletMutation.mutate(walletAddress);
  };
  ...
  // Effect to check wallet validity on load
  useEffect(() => {
    if (walletAddress && !validWallet && !verifyWalletMutation.isPending) {
      verifyWalletMutation.mutate(walletAddress);
    }
  }, [walletAddress]);
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  {verifyWalletMutation.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                  Verify Wallet
                </Button>
                <Button
                  variant="outline"
